 ...
 * @@ Objective (ban.c)
 *
 * This file contains the functions and support for banning players and 
 * sites.  Includes the load_ban and save_ban (instead of being in data_h.c)
 */
...
void save_bans (void)
{
	...
	sprintf (file, "%s%s", DATA_DIR, BAN_FILE);
